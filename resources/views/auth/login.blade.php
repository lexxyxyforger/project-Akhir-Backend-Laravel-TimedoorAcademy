            ...
            <div class="card-inner">
                ...
                <form action="{{ route('login') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="email" placeholder="nama@email.com" required class="form-input">
                    </div>
                    <div class="form-group">
                        <label class="form-label">Password</label>
                        <input type="password" name="password" placeholder="••••••••" required class="form-input">
                    </div>
                    <button type="submit" class="btn-submit"><span>Masuk</span></button>
                </form>
