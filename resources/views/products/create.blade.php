...
<head>
    ...
    <title>Tambah Produk | AdaStore</title>
...
<body>
            ...
            <div class="card-inner">
                <div class="card-header">
                    <div class="card-title-wrap">
                        ...
                        <h1 class="card-title">Tambah <span>Produk</span></h1>
                        <p class="card-subtitle">AdaStore &nbsp;·&nbsp; Inventori</p>
                    </div>
                ...
                <form id="productForm" action="{{ route('products.store') }}" method="POST"
                    ...
                    <p class="form-section-label">Visual Produk</p>
                    ...
                    <div class="form-group hidden" id="file-container">
                        <div class="dropzone" id="dropzone">
                            ...
                            <p class="dropzone-text">Drag & Drop Gambar</p>
                            <p class="dropzone-sub">Maks. 2MB — klik untuk pilih</p>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrap">
                            ...
                            <input type="text" name="name" required placeholder="Nama produk..." class="form-input">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrap">
                                ...
                                <input type="number" name="stock" required placeholder="0" class="form-input">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="input-wrap">
                            ...
                            <input type="text" id="display_price" placeholder="0" required class="price-input">
                    ...
                    <button type="submit" class="btn-submit" style="margin-top:0.5rem;">
                        ...
                        <i data-lucide="plus" class="btn-submit-icon"></i>
                    </button>
                </form>
            </div>
        </div>
    ...
    document.getElementById('productForm').addEventListener('submit', function(e) {
        ...
        Swal.fire({
            title: 'Simpan Produk?',
            text: 'Data produk akan ditambahkan ke inventori.',
            icon: 'question',
